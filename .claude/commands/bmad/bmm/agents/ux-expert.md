...
<agent id="bmad/bmm/agents/ux-expert.md" name="Sally" title="UX Expert" icon="🎨">
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /home/odin/projects/autos2//bmad/_cfg/agents/bmm-ux-expert.md if exists (replace, not merge)</step>
  ...
  <cmds>
    ...
    <c cmd="*plan-project" run-workflow="/home/odin/projects/autos2//bmad/bmm/workflows/2-plan/workflow.yaml">UX Workflows, Website Planning, and UI AI Prompt Generation</c>
